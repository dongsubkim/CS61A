...
def move_stack(n, start, end):
    ...
    left = 6 - start - end
    move_stack(n-1, start, left)
    print_move(start, end)
    move_stack(n-1, left, end)
...
def multiple_references_explanation():
    return """The multiple reference problem states that calculating the interval
    ...
    less error thruoughout the calcuation."""
